...
export const services: Service[] = [
  ...
  },
  {
    ...
    body: 'Ich unterstütze Unternehmen dabei, KI dort einzusetzen, wo sie messbaren Nutzen schafft: in wiederkehrenden Abläufen, wissensintensiven Prozessen und bestehenden Softwarelandschaften. Auf Basis moderner LLMs entwickle ich produktionsreife KI-Anwendungen — integriert, evaluiert und mit klaren Guardrails für sicheren Betrieb.',
    tags: [
      'LLM-Integration',
      'RAG',
      'KI-Automatisierung',
